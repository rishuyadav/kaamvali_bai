                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="allotId" id="input-id" class="form-control" readonly value="<?php if (isset($_GET['request_id'])) {
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="form-control-label" for="input-room">Location</label>
                        <input type="text" name="allotRoom" id="input-room" class="form-control" disabled value="<?php if (isset($_GET['room_num'])) {
                                                                                                                    echo $_GET['room_num'];
                                                                                                                  } ?>">
                      </div>
                    </div>
